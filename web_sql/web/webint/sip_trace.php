...
$opts['fdd']['ip_src'] = array(
  'name'     => 'Ip src',
  'select'   => 'T',
  'maxlen'   => 15,
  'sort'     => true
);
$opts['fdd']['port_src'] = array(
  'name'     => 'Port src',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['ip_dst'] = array(
  'name'     => 'Ip dst',
  'select'   => 'T',
  'maxlen'   => 15,
  'sort'     => true
);
$opts['fdd']['port_dst'] = array(
  'name'     => 'Port dst',
  'select'   => 'T',
  'maxlen'   => 11,
  'sort'     => true
);
$opts['fdd']['method'] = array(
  'name'     => 'Method',
  'select'   => 'T',
  'maxlen'   => 45,
  'sort'     => true
...
$opts['fdd']['from_host'] = array(
  'name'     => 'From host',
  'select'   => 'T',
  'maxlen'   => 15,
  'sort'     => true
);
$opts['fdd']['ruri_host'] = array(
  'name'     => 'Ruri host',
  'select'   => 'T',
  'maxlen'   => 45,
  'sort'     => true
);
$opts['fdd']['ruri_user'] = array(
  'name'     => 'Ruri user',
  'select'   => 'T',
  'maxlen'   => 45,
  'sort'     => true
);
$opts['fdd']['call_id'] = array(
  'name'     => 'Call ID',
  'select'   => 'T',
  'maxlen'   => 80,
  'sort'     => true
