...
$opts['pw'] = 'V1k1ng';
$opts['db'] = 'viking';
$opts['tb'] = 'ws_customers';

// Name of field which is the unique key
$opts['key'] = 'ws_customer_id';

// Type of key field (int/real/string/date etc.)
$opts['key_type'] = 'int';

// Sorting field(s)
$opts['sort_field'] = array('ws_customer_id');
...
$opts['fdd']['ws_customer_contact_email'] = array(
  'name'     => 'email',
  'select'   => 'T',
  'maxlen'   => 300,
  'sort'     => true
...
$opts['fdd']['ws_customer_fax'] = array(
  'name'     => 'Fax',
  'select'   => 'T',
  'maxlen'   => 135,
  'sort'     => true
...
$opts['fdd']['ws_customer_sig_ip'] = array(
  'name'     => 'SIP IP',
  'select'   => 'T',
  'maxlen'   => 45,
  'sort'     => true,
...
$opts['fdd']['ws_customer_context'] = array(
  ...
  'sort'     => true,
  'required' => true,
  'values'   => array( 'table' => 'ws_settings','column' => 'service_type')
);
...
$opts['fdd']['ws_customer_balance'] = array(
  'name'     => 'Balance',
  'select'   => 'T',
  'maxlen'   => 13,
  'default'  => '0.0000',
