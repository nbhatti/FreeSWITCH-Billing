...
$opts['fdd']['contact_email'] = array(
  'name'     => 'Contact email',
  'select'   => 'T',
  'maxlen'   => 150,
  'sort'     => true
);
$opts['fdd']['sip_ip'] = array(
  'name'     => 'Sip ip',
  'select'   => 'T',
  'maxlen'   => 75,
  'sort'     => true
);
$opts['fdd']['rtp_ip'] = array(
  'name'     => 'Rtp ip',
  'select'   => 'T',
  'maxlen'   => 57,
  'sort'     => true
);
$opts['fdd']['codec_list'] = array(
  'name'     => 'Codec list',
  'select'   => 'T',
  'maxlen'   => 150,
  'sort'     => true
);
$opts['fdd']['strip_digits'] = array(
  'name'     => 'Strip digits',
  'select'   => 'T',
  'maxlen'   => 60,
  'sort'     => true
);
$opts['fdd']['out_prefix'] = array(
  'name'     => 'Out prefix',
  'select'   => 'T',
  'maxlen'   => 45,
  'sort'     => true
);
$opts['fdd']['cost_table'] = array(
  'URL'      => 'viewcosts.php?costtable=$value',
  'name'     => 'Cost table',
  'select'   => 'T',
  'maxlen'   => 75,
  'sort'     => true,
    'values'   => array('table' => 'view_cost_tables','column' => 'table_name')
);
$opts['fdd']['sip_username'] = array(
  'name'     => 'Sip username',
  'select'   => 'T',
  'maxlen'   => 135,
  'default'  => '1234',
